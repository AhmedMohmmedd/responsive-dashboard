...
abstract class AppStyles {
  ...
  static const TextStyle styleSimiBolde16 = TextStyle(
    color: Color(0xFF064060),
    fontSize: 16,
    fontFamily: 'Montserrat',
    fontWeight: FontWeight.w600,
  );
  static const TextStyle styleSimiBolde20 = TextStyle(
    color: Color(0xFF064060),
    fontSize: 20,
    fontFamily: 'Montserrat',
    fontWeight: FontWeight.w600,
  ...
  static const TextStyle styleRegular12 = TextStyle(
   ...
   static const TextStyle styleSimiBolde24 = TextStyle(
  ...
  static const TextStyle styleSimiBolde18 = TextStyle(
    color: Colors.white,
    fontSize: 18,
    fontFamily: 'Montserrat',
    fontWeight: FontWeight.w600,
